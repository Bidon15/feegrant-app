            ...
            {namespaces && namespaces.length > 0 ? (() => {
              ...
              <div className="space-y-3">
                {filteredNamespaces.map((ns) => {
                  ...
                  // Track which repos are already linked to this namespace
                          ...
                          <div className="p-2 rounded bg-background/50 border border-border/50">
                            ...
                            {isLoadingRepos ? (
                              <div className="flex items-center justify-center py-4 gap-2">
                                ...
                                <span className="text-xs text-muted-foreground">Loading repos...</span>
                              </div>
                              ...
                              <div className="space-y-1 max-h-40 overflow-y-auto">
                                {availableRepos.slice(0, 15).map((repo) => {
                                  ...
                                  const isAlreadyLinked = alreadyLinkedRepoIds.has(repo.id);
                                  return (
                                    <button
                                      key={repo.id}
                                      onClick={() => {
                                      ...
                                      disabled={isAdding || addRepoToNamespace.isPending || isAlreadyLinked}
                                      className={`w-full text-left px-2 py-2 rounded text-xs font-mono transition-colors flex items-center justify-between gap-2 ${
                                        isAdding
